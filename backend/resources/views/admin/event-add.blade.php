    ...
    <div class="main-content-wrap">
        <div class="flex items-center flex-wrap justify-between gap20 mb-27">
            ...
            <ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
                ...
                <li><i class="icon-chevron-right"></i></li>
                <li><div class="text-tiny">Add Event</div></li>
            </ul>
        </div>

        <form class="tf-section-2 form-add-product" method="POST" enctype="multipart/form-data" action="{{ route('admin.event.save') }}">
            @csrf
            <div class="wg-box">
                @if (session('status'))
                ...
                <fieldset>
                    ...
                    <input class="mb-10" type="text" name="title" placeholder="Enter event title" value="{{ old('title') }}" required>
                </fieldset>
                @error("title") <span class="alert alert-danger">{{$message}}</span> @enderror
                <!-- Slug -->
                <fieldset>
                    <div class="body-title mb-10">Slug</div>
                    <input class="mb-10" type="text" name="slug" placeholder="Auto generated" value="{{ old('slug') }}" required>
                </fieldset>
                ...
                <div class="gap22 cols">
                    <fieldset>
                        ...
                        <input type="text" name="venue" placeholder="Enter event venue" value="{{ old('venue') }}" required>
                    </fieldset>
                    <fieldset>
                ...
                <fieldset>
                    ...
                    <textarea class="mb-10" name="description" placeholder="Full description">{{ old('description') }}</textarea>
                </fieldset>
                    ...
                    <div class="upload-image flex-grow">
                        ...
                        <div id="upload-file" class="item up-load">
                            <label class="uploadfile">
                                ...
                                <input type="file" id="featureImage" name="feature_image" accept="image/*" required>
                            </label>
                        </div>
                    </div>
                </fieldset>
                        ...
                        <div id="galleryUpload" class="item up-load">
                            <label class="uploadfile">
                                ...
                                <span class="text-tiny">
                                    Drop multiple images or 
                                    <span class="tf-color">click to browse</span>
                                </span>
                                <input type="file" id="galleryImages" name="images[]" accept="image/*" multiple required>
                            </label>
                        </div>
                    </div>
                </fieldset>
